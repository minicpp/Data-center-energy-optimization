function [P_TOTAL,P_AC,P_CMP,T_sup,COP,Job_distribute,Res_cvx] = dc_schedule(job_size, job_calc_req, schedule_array, Apath, red_temperature)
%cvx_solver SDPT3
